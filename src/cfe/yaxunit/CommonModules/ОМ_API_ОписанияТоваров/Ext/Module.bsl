...
Процедура ИсполняемыеСценарии() Экспорт
    ...
    ЮТТесты.ДобавитьТестовыйНабор("API ОписанияТоваров: Получить товар по артикулу")
		.ДобавитьТест("ПолучитьОписаниеТоваровПоАртикулуПозитив", "Получение описания товаров (Позитив)") 
		.ДобавитьТест("ПолучитьОписаниеТоваровПоАртикулуНегатив", "Получение описания товаров (Негатив)") 
		.ДобавитьТест("ПолучитьОписаниеТоваровПоАртикулуПозитивСоздание").ВТранзакции()
		;
